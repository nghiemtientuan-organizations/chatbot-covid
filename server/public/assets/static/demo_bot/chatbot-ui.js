...
function init(botLogoPath) {
    ...
    <div class='chat-popup'>
		...
		<div class='chat-area'>
			...
			<div class="bot-msg bot-msg-selects">
			    <button class="customer-button-option">Khai báo y tế</button>
			    <button class="customer-button-option">Điều trị Covid</button>
			</div>
		</div>
    ...
    chatBtn.addEventListener("click", () => {
        ...
        if (chatPopup.style.display == "none" && mobileDevice) {
            ...
            chatInput.focus();
            chatBtn.innerHTML = `<img src = "assets/icons/close.png" class = "material-icon" >`
    ...
    expandWindow.addEventListener("click", (e) => {
        ...
        if (expandWindow.innerHTML == '<img src="assets/icons/open_fullscreen.png" class="material-icon">') {
            expandWindow.innerHTML = `<img src = "assets/icons/close_fullscreen.png" class = 'material-icon'>`
            root.style.setProperty('--chat-window-height', 80 + "%");
            root.style.setProperty('--chat-window-total-width', 85 + "%");
            chatHeader.style.width = "100%";
        } else if (expandWindow.innerHTML == '<img src="assets/icons/close.png" class="material-icon">') {
            chatPopup.style.display = "none"
            chatBtn.style.display = "block"
        } else {
            expandWindow.innerHTML = `<img src = "assets/icons/open_fullscreen.png" class = "material-icon" >`
...
function mobileView() {
    ...
    if (chatPopup.style.display == "none") {
        ...
        expandWindow.innerHTML = `<img src = "assets/icons/close.png" class = "material-icon" >`
    }
}
